            ...
            <!-- Stats Cards -->
                <div class="stats-grid">
                    ...
                    <div class="stat-header">
                        ...
                        <div class="stat-trend {{ $stats['users_growth'] >= 0 ? 'positive' : 'negative' }}">
                            <i class="bi bi-arrow-{{ $stats['users_growth'] >= 0 ? 'up' : 'down' }}"></i>
                            <span>{{ abs($stats['users_growth']) }}%</span>
                        </div>
                        </div>
                        <div class="stat-content">
                            <h3 class="stat-number">{{ number_format($stats['total_users']) }}</h3>
                            <p class="stat-label">Total Users</p>
                        <span class="stat-change">{{ $stats['users_growth'] >= 0 ? '+' : '' }}{{ $stats['users_growth'] }}% dari bulan lalu</span>
                        </div>
                    </div>
                    ...
                    <div class="stat-header">
                        ...
                        <div class="stat-trend {{ $stats['gallery_growth'] >= 0 ? 'positive' : 'negative' }}">
                            <i class="bi bi-arrow-{{ $stats['gallery_growth'] >= 0 ? 'up' : 'down' }}"></i>
                            <span>{{ abs($stats['gallery_growth']) }}%</span>
                        </div>
                        </div>
                        <div class="stat-content">
                            <h3 class="stat-number">{{ number_format($stats['total_gallery']) }}</h3>
                            <p class="stat-label">Foto Galeri</p>
                        <span class="stat-change">{{ $stats['gallery_growth'] >= 0 ? '+' : '' }}{{ $stats['gallery_growth'] }}% dari bulan lalu</span>
                        </div>
                    </div>
                    ...
                    <div class="stat-header">
                        ...
                        <div class="stat-trend {{ $stats['agenda_growth'] >= 0 ? 'positive' : ($stats['agenda_growth'] == 0 ? 'neutral' : 'negative') }}">
                            <i class="bi bi-{{ $stats['agenda_growth'] == 0 ? 'dash' : 'arrow-' . ($stats['agenda_growth'] >= 0 ? 'up' : 'down') }}"></i>
                            <span>{{ abs($stats['agenda_growth']) }}%</span>
                        </div>
                        </div>
                        <div class="stat-content">
                            <h3 class="stat-number">{{ number_format($stats['total_agenda']) }}</h3>
                            <p class="stat-label">Agenda Aktif</p>
                        <span class="stat-change">{{ $stats['agenda_growth'] == 0 ? 'Tidak berubah' : ($stats['agenda_growth'] >= 0 ? '+' : '') . $stats['agenda_growth'] . '% dari bulan lalu' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="stat-header">
                        ...
                        <div class="stat-trend positive">
                            ...
                            <span>{{ $stats['views_growth'] }}%</span>
                        </div>
                        </div>
                        <div class="stat-content">
                            <h3 class="stat-number">{{ number_format($stats['total_views']) }}</h3>
                            <p class="stat-label">Total Views</p>
                        <span class="stat-change">+{{ $stats['views_growth'] }}% dari bulan lalu</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="activity-list">
                            ...
                            <div class="activity-item">
                                ...
                                <div class="activity-status">
                                    <span class="status-badge {{ $activity['type'] }}">{{ $activity['status'] }}</span>
                                </div>
                            </div>
                            @empty
                            <div class="activity-item">
                                <div class="activity-content">
                                    <p class="activity-text text-muted">Belum ada aktivitas terbaru</p>
                                </div>
                            </div>
                            @endforelse
                        </div>
                    ...
                    <div class="users-list">
                        ...
                        <div class="user-item">
                            ...
                            <div class="user-status">
                                <span class="status-badge {{ $user->status == 'active' ? 'success' : 'warning' }}">
                        ...
                        <div class="user-item">
                            <div class="user-info">
                                <span class="user-name text-muted">Belum ada user terbaru</span>
                            </div>
                        </div>
                        @endforelse
                    </div>
